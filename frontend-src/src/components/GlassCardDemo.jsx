      ...
      */}
      ...
      >
        <div className="flex flex-col gap-4">
          ...
          <div className="w-12 h-12 rounded-xl bg-white flex items-center justify-center border border-edge mb-2">
          ...
          <h2 className="text-primary-500xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
            Premium Experience
          </h2>
          ...
          <button className="mt-4 py-3 px-6 rounded-xl bg-white hover:bg-white/20 text-primary-900 font-semibold border border-edge transition-colors">
            Get Started
          </button>
        </div>
      </motion.div>
